...
def parse_args():
    ...
    parser.add_argument('--save_name', type=str, default='model_for_dhb')
...
def train_inter(args):
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 100 == 0:
            torch.save(net.state_dict(), args.mid_save_dir + 'SRmodel_' + str(epoch) + args.save_name + '.pth')

        if total_loss < best_loss:
            torch.save(net.state_dict(), args.save_dir + 'SRmodel' + args.save_name + '.pth')
